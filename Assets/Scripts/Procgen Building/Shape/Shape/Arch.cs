...
public class Arch : CalculatedShape
{
    ...
    public override Vector3[] ControlPoints()
    {
        ...
        controlPoints.AddRange(Vector3Extensions.QuadraticLerpCollection(new Vector3(-1, -1 + m_BaseHeight), new Vector3(0, -1 + m_BaseHeight + m_ArchHeight), new Vector3(1, -1 + m_BaseHeight), m_Sides));
